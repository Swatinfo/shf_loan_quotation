...
<head>
  ...
  <meta name="description" content="Home Loan with Shreenathji Home Finance (SHF) — compare offers across our lender panel, long tenure options, transparent charges, dedicated advisor.">
  <title>Home Loan — SHF | Shreenathji Home Finance</title>
...
<section class="page-header">
  <div class="container">
    <div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="services">Services</a><span>/</span>Home Loan</div>
    <div class="brand-tagline brand-tagline--page">Shaping Happiness Forever</div>
    <h1>Home Loan</h1>
    <p>Buy, build or renovate — with long-tenure options and competitive rates, matched to your profile across our lender panel.</p>
  </div>
</section>
...
<section class="section">
  <div class="container about-grid">
    <div>
      ...
      <h2>The loan that puts a roof over everything else.</h2>
      <p>
        A home loan is usually the largest financial commitment a family takes on.
        That's why we treat it with the seriousness it deserves — running your profile
        through a panel of 15+ lenders, flagging every charge upfront, and walking you
        through the EMI, tax impact and tenure trade-offs before you sign anything.
      </p>
      <p>
        Whether it's a ready flat, a plot + construction plan, or a house that needs
        renovation, we find the product and lender that actually fit your situation.
      </p>
      ...
      <a href="contact" class="btn btn-accent">Get a Home Loan Quote</a>
    </div>
...
<section class="section section-soft">
  <div class="container">
    <div class="text-center">
      ...
      <h2 class="section-title">What You Get With SHF</h2>
    </div>
    <div class="feature-grid">
      <div class="feature-tile">
        <div class="icon-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9h6v6H9z"/></svg></div>
        <h4>Lender Comparison</h4>
        <p>See the numbers from 15+ banks and NBFCs in one view — rates, processing fees, tenure, turnaround.</p>
      </div>
      <div class="feature-tile">
        <div class="icon-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2" stroke-linecap="round"/></svg></div>
        <h4>Long-Tenure Options</h4>
        <p>Select tenures that stretch the EMI comfortably — subject to your age and retirement horizon.</p>
      </div>
      <div class="feature-tile">
        <div class="icon-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13A4 4 0 0 1 16 11"/></svg></div>
        <h4>Co-Applicant Support</h4>
        <p>Add spouse, parents, adult children as co-borrowers — improves eligibility and widens tax-benefit coverage.</p>
      </div>
      <div class="feature-tile">
        <div class="icon-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z" stroke-linejoin="round"/><path d="M2 17l10 5 10-5M2 12l10 5 10-5" stroke-linejoin="round"/></svg></div>
        <h4>All Property Types</h4>
        <p>Ready-to-move, under-construction, plot + construction, resale, builder projects — we handle every kind.</p>
      </div>
      <div class="feature-tile">
        <div class="icon-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 7L9 18l-5-5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
        <h4>Zero Consulting Fees</h4>
        <p>Free initial consultation, eligibility check and comparison quotation. No hidden advisory charges.</p>
      </div>
      <div class="feature-tile">
        <div class="icon-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
        <h4>Digital Tracking</h4>
        <p>Every stage of your file visible to you — know exactly what's next and who's handling it.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="text-center">
      ...
      <p class="section-lead">Salaried professionals, self-employed, business owners, NRIs — we tailor the file for each.</p>
    </div>
    <div class="service-grid">
      <div class="service-card">
        <h3>Salaried</h3>
        <p>Employed professionals with a stable income and verifiable salary credit.</p>
        <ul class="service-features">
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12" stroke-linecap="round" stroke-linejoin="round"/></svg>Age 21–65</li>
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12" stroke-linecap="round" stroke-linejoin="round"/></svg>Minimum 2 years of employment</li>
        </ul>
      </div>
      <div class="service-card">
        <h3>Self-Employed</h3>
        <p>Proprietors, partnerships, LLPs, private limited directors with filed ITRs.</p>
        <ul class="service-features">
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12" stroke-linecap="round" stroke-linejoin="round"/></svg>Minimum 3 years of business vintage</li>
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12" stroke-linecap="round" stroke-linejoin="round"/></svg>Last 3 years of ITR</li>
        </ul>
      </div>
      <div class="service-card">
        <h3>NRI &amp; PIO</h3>
        <p>NRIs and Persons of Indian Origin investing in Indian residential property.</p>
        <ul class="service-features">
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12" stroke-linecap="round" stroke-linejoin="round"/></svg>Valid NRI status &amp; overseas income proof</li>
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12" stroke-linecap="round" stroke-linejoin="round"/></svg>POA in India (guided by us)</li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="section section-soft">
  <div class="container">
    <div class="text-center">
      ...
      <h2 class="section-title">Home Loan — Commonly Asked</h2>
    </div>
    <div class="faq">
      <div class="faq-item">
        <button class="faq-q"><span>How much home loan can I get?</span>
      ...
      <div class="faq-item">
        <button class="faq-q"><span>What's the typical processing time?</span>
          <svg class="plus" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14" stroke-linecap="round"/></svg>
        </button>
        <div class="faq-a"><div class="faq-a-inner">
      ...
      <div class="faq-item">
        <button class="faq-q"><span>Can I get tax benefits on a home loan?</span>
          <svg class="plus" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14" stroke-linecap="round"/></svg>
        </button>
        <div class="faq-a"><div class="faq-a-inner">
...
<section class="cta-strip">
  <div class="container">
    <div>
      <h2>Planning a home purchase?</h2>
      <p>Get a free, profile-specific comparison quote across 15+ lenders — no obligation.</p>
    </div>
...
<a href="https://wa.me/919099089072?text=Hi%20SHF%2C%20I%27d%20like%20to%20know%20more%20about%20your%20Home%20Loan." target="_blank" rel="noopener" class="wa-fab" aria-label="Chat on WhatsApp">
