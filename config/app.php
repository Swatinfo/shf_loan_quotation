...
return [
    ...
    */
    ...
    'shf_version' => env('SHF_VERSION', '20260601143000'),

    // Where queue-backlog alerts (QueueBusy event → AlertOnQueueBusy listener) are
    // emailed. Set QUEUE_ALERT_EMAIL in .env to override. Empty disables the email.
    'queue_alert_email' => env('QUEUE_ALERT_EMAIL', 'mailmeonparsana@gmail.com'),
    ...
    |--------------------------------------------------------------------------
    |
    | Path to Chrome browser for headless PDF generation.
    |
    */
