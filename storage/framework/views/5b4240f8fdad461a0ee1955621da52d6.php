<?php $__env->startSection('title', 'Dashboard — SHF'); ?>
    ...
    <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center justify-content-between gap-2">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <?php if(auth()->user()->hasPermission('create_quotation')): ?>
                <a href="<?php echo e(route('quotations.create')); ?>" class="btn-accent btn-accent-sm">
            ...
            <?php if(auth()->user()->hasPermission('create_dvr')): ?>
                <button class="btn-accent-outline btn-accent-outline-white btn-accent-sm" data-bs-toggle="modal"
...
<?php $__env->startSection('content'); ?>
    <div class="py-4">
        <div class="px-3 px-sm-4 px-lg-5">
            ...
            <div class="row g-3 mb-4">
                <?php $statCol = ($canViewQuotations && $loanStats) ? '2' : '4'; ?>

                
                <?php if($canViewQuotations): ?>
                    <div class="col-6 col-md-<?php echo e($statCol); ?>">
                    ...
                    <div class="col-6 col-md-<?php echo e($statCol); ?>">
                        <div class="shf-stat-card">
                            ...
                            <div>
                                <div class="shf-stat-value"><?php echo e(number_format($stats['today'])); ?></div>
                ...
                <?php if($loanStats): ?>
                    <div class="col-6 col-md-<?php echo e($statCol); ?>">
                        <div class="shf-stat-card shf-stat-card-blue">
                            ...
                            <div>
                                <div class="shf-stat-value"><?php echo e(number_format($loanStats['active'])); ?></div>
                    ...
                    <div class="col-6 col-md-<?php echo e($statCol); ?>">
                        <div class="shf-stat-card shf-stat-card-accent">
                            ...
                            <div>
                                <div class="shf-stat-value"><?php echo e(number_format($loanStats['my_tasks'])); ?></div>
                    ...
                    <div class="col-6 col-md-<?php echo e($statCol); ?>">
                        <div class="shf-stat-card shf-stat-card-green">
                            ...
                            <div>
                                <div class="shf-stat-value"><?php echo e(number_format($loanStats['completed_month'])); ?></div>
            ...
            <div class="shf-tabs">
                <button class="shf-tab<?php echo e($defaultTab === 'personal-tasks' ? ' active' : ''); ?>"
                    data-tab="dash-personal-tasks">
                    Personal Tasks
                    <?php if($personalTaskStats['pending'] > 0): ?>
                        <span
                            class="shf-badge shf-badge-orange shf-badge-username ms-1 shf-text-2xs"><?php echo e($personalTaskStats['pending']); ?></span>
                    <?php endif; ?>
                </button>
                <?php if($loanStats): ?>
                    <button class="shf-tab<?php echo e($defaultTab === 'tasks' ? ' active' : ''); ?>" data-tab="dash-tasks">
                        My Tasks
                        <?php if($loanStats['my_tasks'] > 0): ?>
                            <span
                                class="shf-badge shf-badge-orange shf-badge-username ms-1 shf-text-2xs"><?php echo e($loanStats['my_tasks']); ?></span>
                        <?php endif; ?>
                    </button>
                    <button class="shf-tab<?php echo e($defaultTab === 'loans' ? ' active' : ''); ?>"
                        data-tab="dash-loans">Loans</button>
                <?php endif; ?>
                <?php if($canViewDvr): ?>
                    <button class="shf-tab<?php echo e($defaultTab === 'dvr' ? ' active' : ''); ?>" data-tab="dash-dvr">
                        DVR
                        <?php if($dvrStats && ($dvrStats['overdue_follow_ups'] + $dvrStats['pending_follow_ups']) > 0): ?>
                            <span class="shf-badge <?php echo e($dvrStats['overdue_follow_ups'] > 0 ? 'shf-badge-red' : 'shf-badge-orange'); ?> shf-badge-username ms-1 shf-text-2xs">
                                <?php echo e($dvrStats['overdue_follow_ups'] + $dvrStats['pending_follow_ups']); ?>
                ...
                <?php endif; ?>
                <?php if($canViewQuotations): ?>
                    <button class="shf-tab<?php echo e($defaultTab === 'quotations' ? ' active' : ''); ?>"
            ...
            <?php if($loanStats): ?>
                <?php
                    ...
                    $taskStages = \App\Models\Stage::where('is_enabled', true)
                        ...
                        ->get();
                ?>
                <div class="settings-tab-pane shf-collapse-hidden" id="tab-dash-tasks"<?php echo $defaultTab !== 'tasks' ? '' : ''; ?>>
                            ...
                            <div class="row g-2 align-items-end">
                                <div class="col-6 col-md-auto">
                                    ...
                                    <select id="dashTaskStage" class="shf-input shf-input-sm">
                                        ...
                                        <?php $__currentLoopData = $taskStages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($st->stage_key); ?>"><?php echo e($st->stage_name_en); ?></option>
                ...
                <div class="shf-section shf-section-no-top-radius">
                    <div class="shf-section-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('general-tasks.index')); ?>"
                ...
                <div class="settings-tab-pane shf-collapse-hidden" id="tab-dash-dvr">
                    <div class="shf-section shf-section-no-top-radius">
                        <div class="shf-section-header d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('dvr.index')); ?>"
                                    class="btn-accent-outline btn-accent-outline-white btn-accent-sm shf-text-xs">
                                    <svg class="shf-icon-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M4 6h16M4 10h16M4 14h16M4 18h16" />
            ...
            <?php if($canViewQuotations): ?>
                <div class="settings-tab-pane shf-collapse-hidden" id="tab-dash-quotations"<?php echo $defaultTab !== 'quotations' ? '' : ''; ?>>
                    <div class="shf-section shf-section-no-top-radius">
                        ...
                        <div id="quotFilterBody" class="shf-section-body shf-filter-body-collapse"
                            ...
                            <div class="row g-3 align-items-end">
                                ...
                                <?php if($permissions['view_all'] && count($users) > 0): ?>
                                    <div class="col-6 col-md-auto" style="min-width: 10rem;">
                        ...
                        <div id="empty-state" class="p-5 text-center shf-collapse-hidden">
                            ...
                            <?php if(auth()->user()->hasPermission('create_quotation')): ?>
                                <div id="empty-state-cta" class="mt-4">
                                    <a href="<?php echo e(route('quotations.create')); ?>" class="btn-accent">
                                        <svg class="shf-icon-md" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 4v16m8-8H4" />
            ...
            <?php if($loanStats): ?>
                <div class="settings-tab-pane shf-collapse-hidden" id="tab-dash-loans"<?php echo $defaultTab !== 'loans' ? '' : ''; ?>>
                    <div class="shf-section shf-section-no-top-radius">
                                    ...
                                    <select id="dashLoanStatus" class="shf-input shf-input-sm">
                                        ...
                                        <?php $__currentLoopData = \App\Models\LoanDetail::STATUS_LABELS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>"
                                                <?php echo e($key === 'active' ? 'selected' : ''); ?>><?php echo e($label['label']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-6 col-md-auto">
                                ...
                                <?php if(!$isBankEmp): ?>
                                    <div class="col-6 col-md-auto">
                                        ...
                                        <select id="dashLoanBank" class="shf-input shf-input-sm">
                                            ...
                                            <?php $__currentLoopData = \App\Models\Bank::active()->orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($isAdminOrMgr): ?>
                                    <div class="col-6 col-md-auto">
                                        ...
                                        <select id="dashLoanBranch" class="shf-input shf-input-sm">
                                            ...
                                            <?php $__currentLoopData = \App\Models\Branch::active()->orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $br): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div id="loansDashFooter" class="text-center py-3 shf-border-top-light">
                            <a href="<?php echo e(route('loans.index')); ?>" class="btn-accent-outline btn-accent-sm"><svg
    ...
    <div class="modal fade" id="dashCreateTaskModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="border: none; border-radius: 12px;">
                <form id="dashTaskForm" method="POST" action="<?php echo e(route('general-tasks.store')); ?>">
                    <?php echo csrf_field(); ?>
                                ...
                                <select name="assigned_to" class="shf-input">
                                    ...
                                    <?php $__currentLoopData = $activeUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($u->id); ?>"
                                            <?php echo e($u->id === auth()->id() ? 'selected' : ''); ?>><?php echo e($u->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
    ...
    <?php if(auth()->user()->hasPermission('create_dvr')): ?>
        <div class="modal fade" id="dashCreateDvrModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="border: none; border-radius: 12px;">
                    <form id="dashDvrForm" method="POST" action="<?php echo e(route('dvr.store')); ?>">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-md-4">
                                    ...
                                    <select name="contact_type" id="dashDvrContactType" class="shf-input" required>
                                        ...
                                        <?php $__currentLoopData = $dvrConfig['contactTypes'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($ct['key']); ?>"><?php echo e($ct['label_en']); ?> / <?php echo e($ct['label_gu']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select name="purpose" class="shf-input" required>
                                        <option value="">Select...</option>
                                        <?php $__currentLoopData = $dvrConfig['purposes'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($p['key']); ?>"><?php echo e($p['label_en']); ?> / <?php echo e($p['label_gu']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-4">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $(function() {
            ...
            var canViewAll = <?php echo json_encode($permissions['view_all'] ?? false, 15, 512) ?>;
            var canDownload = <?php echo json_encode($permissions['download_pdf'] ?? false, 15, 512) ?>;
            var canDownloadBranded = <?php echo json_encode($permissions['download_pdf_branded'] ?? false, 15, 512) ?>;
            var canDownloadPlain = <?php echo json_encode($permissions['download_pdf_plain'] ?? false, 15, 512) ?>;
            var canDelete = <?php echo json_encode($permissions['delete_quotations'] ?? false, 15, 512) ?>;
            var hasFilters = false;
            var deleteUrl = null;
            var deleteModal = document.getElementById('deleteModal') ? new bootstrap.Modal(document.getElementById(
                'deleteModal')) : null;
            var dataUrl = <?php echo json_encode(route('dashboard.quotation-data'), 15, 512) ?>;
            ...
            function initDvrTable() {
                ...
                dvrTable = $('#dashDvrTable').DataTable({
                    ...
                    ajax: {
                        url: <?php echo json_encode(route('dashboard.dvr-data'), 15, 512) ?>,
                        data: function(d) {
            ...
            function initTasksTable() {
                ...
                tasksTable = $('#tasksTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: <?php echo json_encode(route('dashboard.task-data'), 15, 512) ?>,
                        data: function(d) {
            ...
            function initPersonalTasksTable() {
                ...
                var emptyPersonalHtml = '<div class="p-5 text-center">' +
                    ...
                    '<a href="' + <?php echo json_encode(route('general-tasks.index'), 15, 512) ?> +
                ...
                personalTasksTable = $('#personalTasksTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: <?php echo json_encode(route('general-tasks.data'), 15, 512) ?>,
                        data: function(d) {
                            d.view = 'all';
                            d.status = 'active';
                        }
            ...
            function initLoansTable() {
                ...
                loansTable = $('#loansTableDash').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: <?php echo json_encode(route('dashboard.loan-data'), 15, 512) ?>,
                        data: function(d) {
            ...
            <?php if($loanStats): ?>
                if (<?php echo json_encode($defaultTab, 15, 512) ?> === 'dash-tasks' || <?php echo json_encode($defaultTab, 15, 512) ?> === 'tasks') {
                    initTasksTable();
                    tasksTableInit = true;
                }
                if (<?php echo json_encode($defaultTab, 15, 512) ?> === 'dash-loans' || <?php echo json_encode($defaultTab, 15, 512) ?> === 'loans') {
                    initLoansTable();
                    loansTableInit = true;
                }
            <?php endif; ?>
            ...
            $('#dashDvrContactPhone, #dashDvrContactName').on('input', function() {
                ...
                dashContactTimer = setTimeout(function() {
                    $.get(<?php echo json_encode(route('dvr.search-contacts'), 15, 512) ?>, { q: q }, function(contacts) {
            ...
            function resetDashTaskForm() {
                $('#dashTaskForm').attr('action', <?php echo json_encode(route('general-tasks.store'), 15, 512) ?>);
                ...
                $('#dashTaskForm select[name="assigned_to"]').val(<?php echo e(auth()->id()); ?>);
            ...
            $('#dashTaskLoanSearch').on('input', function() {
                ...
                dashLoanTimer = setTimeout(function() {
                    $.get(<?php echo json_encode(route('general-tasks.search-loans'), 15, 512) ?>, {
                        q: q
                    }, function(loans) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\G Drive\Projects\quotationshf\resources\views/dashboard.blade.php ENDPATH**/ ?>