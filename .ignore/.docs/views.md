...
- User role badges (colored per role: orange=super_admin, blue=admin, green=branch_manager/bdo, teal=loan_advisor, purple=bank_employee, gray=office_employee)
...
- **Badges**: Role-colored per role (orange/blue/green/teal/purple/gray)
...
- **Workflow fields**: role multi-select, task_bank_id, employee_id, default_branch_id
...
- **5 tabs**:
  ...
  5. **User Roles**: Manage role assignments, task_bank_id, employee_id, branch assignments
