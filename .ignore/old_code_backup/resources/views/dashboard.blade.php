                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="contact_name" id="dashDvrContactName" class="shf-input"
                                        required maxlength="255" placeholder="Search by name..." autocomplete="off">
                                    <div id="dashDvrContactNameResults" class="position-relative">
                                        <div id="dashDvrContactNameDropdown" class="dropdown-menu w-100 shadow"
                                            style="max-height:220px; overflow-y:auto;"></div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        $(function() {
            ...
            // DVR Contact Search on dashboard — dropdown shown below the input being typed in
            var dashContactTimer;
            $('#dashDvrContactPhone, #dashDvrContactName').on('input', function() {
                clearTimeout(dashContactTimer);
                var $input = $(this);
                var dropdownSel = $input.is('#dashDvrContactPhone') ? '#dashDvrContactDropdown' : '#dashDvrContactNameDropdown';
                var otherSel = $input.is('#dashDvrContactPhone') ? '#dashDvrContactNameDropdown' : '#dashDvrContactDropdown';
            ...
            $(document).on('click', '.shf-dash-dvr-contact-pick', function(e) {
                ...
                $('#dashDvrContactDropdown, #dashDvrContactNameDropdown').removeClass('show').empty();
            });
            $(document).on('click', function(e) {
                if (!$(e.target).closest('#dashDvrContactResults, #dashDvrContactNameResults, #dashDvrContactPhone, #dashDvrContactName').length) {
                    $('#dashDvrContactDropdown, #dashDvrContactNameDropdown').removeClass('show');
                }
            });
