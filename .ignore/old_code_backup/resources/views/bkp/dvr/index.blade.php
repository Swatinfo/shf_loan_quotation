                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="contact_name" id="dvrContactName" class="shf-input" required
                                        maxlength="255" value="{{ old('contact_name') }}" autocomplete="off">
                                </div>
                            </div>
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.shf-dvr-contact-pick', function(e) {
                ...
                $('#dvrContactDropdown').removeClass('show').empty();
            });

            // Close dropdowns on outside click
            $(document).on('click', function(e) {
                if (!$(e.target).closest('#dvrContactResults, #dvrContactPhone, #dvrContactName').length) $('#dvrContactDropdown').removeClass('show');
