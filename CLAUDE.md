...
`app/Validation/` holds extracted rule classes (`LoanValidationRules`, `DvrValidationRules`). In-app notifications use bell-badge polling + Web Push (no WebSocket broadcasting).
