...
class LoanSettingsController extends Controller
{
    public function index()
    {
        ...
        $workflowRoles = Role::whereNotIn('slug', ['super_admin'])->orderBy('id')->get();
        $rolePermissions = [];
    ...
    public function saveMasterStages(Request $request)
    {
        ...
        foreach ($changedBankStages as $change) {
            $productIds = Product::where('bank_id', $change['bank_id'])->pluck('id');
    ...
    public function storeLocation(Request $request)
    {
        ...
        if ($locationId) {
            Location::findOrFail($locationId)->update($validated);
    ...
    public function destroyLocation(Location $location): JsonResponse
    {
        ...
        if (Branch::where('location_id', $location->id)->exists()) {
    ...
    public function saveTaskRolePermissions(Request $request)
    {
        ...
        $workflowRoles = Role::whereNotIn('slug', ['super_admin'])->get();
