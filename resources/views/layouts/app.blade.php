...
<head>
    ...
    <meta name="msapplication-TileImage" content="/favicon/icon-192x192.png">
...
<body class="font-body" style="background: #f8f8f8;">
        ...
        @if (session('success'))
            <div class="shf-toast-wrapper">
                <div class="shf-toast success" data-auto-dismiss="5000">
                    ...
                    <button type="button" class="shf-toast-close"
                        style="background:none;border:none;color:rgba(255,255,255,0.5);cursor:pointer;margin-left:8px;">
    ...
    <div id="installBanner"
        ...
        <div
            ...
            <img src="/images/icon-192x192.png" alt="SHF"
