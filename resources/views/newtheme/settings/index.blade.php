...
@php
    $tabs = [
        ...
        'quotation-referral' => ['label' => 'Quotation Referral', 'perm' => 'view_settings', 'num' => '10'],
        'permissions' => ['label' => 'Permissions', 'perm' => 'manage_permissions', 'num' => '11'],
    ];
            ...
            <section class="settings-nt-main">
                ...
                <div class="settings-nt-tabs-wrap">
                    ...
                    <div class="tabs settings-nt-tabs" id="settingsTabsStrip">
                        @foreach ($tabs as $key => $info)
                            <a href="#{{ $key }}" class="tab {{ $activeTab === $key ? 'active' : '' }}"
                                data-tab="{{ $key }}">
                                {{ $info['label'] }}
                            </a>
                        @endforeach
                ...
                <div class="card settings-nt-card">
                    <div class="card-hd settings-nt-card-hd">
                        ...
                        <div class="actions">
                            <span class="settings-nt-breadcrumb">Settings / <span
                                    id="settingsActiveCrumb">Company</span></span>
                        </div>
                    </div>
    ...
    <script>
        (function() {
            ...
            var initial = (window.location.hash || '').replace('#', '') ||
                (function() {
                    try {
                        return localStorage.getItem('shf_settings_active_tab') || '';
                    } catch (e) {
                        return '';
                    }
                })() ||
        ...
        (function() {
            ...
            prev.addEventListener('click', function() {
                scrollBy(-Math.round(strip.clientWidth * 0.75));
            });
