            <div class="shf-card shf-section-no-top-radius">
                    ...
                    <form method="POST" action="{{ route('settings.charges') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <p class="mt-1 shf-text-xs shf-text-gray-light">Loan amount up to which fixed charge
                                    applies
                                </p>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="iomCharges[percentageAbove]" step="0.01"
                                    class="shf-input" value="{{ $config['iomCharges']['percentageAbove'] }}" required>
                ...
                <div class="settings-tab-pane p-4 shf-collapse-hidden" id="tab-bank-charges"{!! $activeTab !== 'bank-charges' ? '' : '' !!}>
                    <form method="POST" action="{{ route('settings.bank-charges') }}" id="bankChargesForm">
                        @csrf
                        <p class="small mb-3 shf-text-gray">Default charges per bank (used when generating quotations).
                        </p>
                ...
                <div class="settings-tab-pane p-4 shf-collapse-hidden" id="tab-gst"{!! $activeTab !== 'gst' ? '' : '' !!}>
                    <form method="POST" action="{{ route('settings.gst') }}">
                        ...
                        <div class="shf-max-w-20">
                            ...
                            <p class="mt-1 shf-text-xs shf-text-gray-light">Applied on PF & Admin charges. e.g. 18 for
                                18%
                            </p>
                        </div>
                ...
                <div class="settings-tab-pane p-4 shf-collapse-hidden" id="tab-services"{!! $activeTab !== 'services' ? '' : '' !!}>
                    <form method="POST" action="{{ route('settings.services') }}">
                        ...
                        <div>
                            ...
                            <p class="mt-1 shf-text-xs shf-text-gray-light">Comma-separated list of services displayed
                                in
                                every PDF footer.</p>
                        </div>
                            ...
                            <div class="doc-type-pane shf-collapse-hidden" id="docPane-{{ $docType }}">
                                ...
                                <div class="shf-reason-add-row row g-2 align-items-end">
                                    ...
                                    <div class="col-12 col-lg-2">
                                        <button type="button"
                                            class="btn-accent-sm addDocBtn w-100 justify-content-center"
                                            data-doc-type="{{ $docType }}"><svg class="shf-icon-sm"
                                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M12 4v16m8-8H4" />
                                            </svg> Add</button>
                ...
                <div class="settings-tab-pane p-4 shf-collapse-hidden" id="tab-dvr">
                    <p class="small mb-3 shf-text-gray">Configure contact types and visit purposes for Daily Visit
                        Reports (DVR).</p>

                    {{-- Contact Types --}}
                    <div class="mb-4">
                        <h6 class="font-display fw-semibold mb-3">Contact Types / સંપર્ક પ્રકાર</h6>
                        <form method="POST" action="{{ route('settings.dvr-contact-types') }}"
                            id="dvrContactTypesForm">
                            @csrf
                            ...
                            <div class="shf-reason-add-row row g-2 align-items-end">
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <input type="text" id="newContactTypeKey" class="shf-input w-100"
                                        placeholder="key (e.g. architect)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <label class="shf-form-label d-block d-lg-none mb-1">English</label>
                                    <input type="text" id="newContactTypeEn" class="shf-input w-100"
                                        placeholder="Label (English)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Gujarati</label>
                                    <input type="text" id="newContactTypeGu" class="shf-input w-100"
                                        placeholder="લેબલ (Gujarati)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-2">
                                    <button type="button" id="addContactTypeBtn"
                                        class="btn-accent-sm w-100 justify-content-center">
                    ...
                    <div>
                        ...
                        <form method="POST" action="{{ route('settings.dvr-purposes') }}" id="dvrPurposesForm">
                            ...
                            <div class="shf-reason-add-row row g-2 align-items-end">
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Key</label>
                                    <input type="text" id="newPurposeKey" class="shf-input w-100"
                                        placeholder="key (e.g. site_visit)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <label class="shf-form-label d-block d-lg-none mb-1">English</label>
                                    <input type="text" id="newPurposeEn" class="shf-input w-100"
                                        placeholder="Label (English)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Gujarati</label>
                                    <input type="text" id="newPurposeGu" class="shf-input w-100"
                                        placeholder="લેબલ (Gujarati)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-2">
                ...
                <div class="settings-tab-pane p-4 shf-collapse-hidden" id="tab-quotation-reasons">
                    <p class="small mb-3 shf-text-gray">Configure the reasons users can choose when putting a quotation
                        on hold or cancelling it.</p>

                    <p class="small mb-3 shf-text-gray-light">Each reason has an optional <strong>Group</strong>.
                        Groups become <code>&lt;optgroup&gt;</code> headings in the Hold / Cancel modal dropdowns, so
                        long lists stay scannable. Leave the group blank to land in "Other".</p>

                    {{-- Hold Reasons --}}
                    <div class="mb-4">
                        <h6 class="font-display fw-semibold mb-3">Hold Reasons / હોલ્ડ કારણો</h6>
                        <form method="POST" action="{{ route('settings.quotation-hold-reasons') }}"
                            id="quotationHoldReasonsForm">
                            @csrf
                            <div class="d-flex flex-column gap-2 mb-3" id="quotationHoldReasonsList"></div>
                            <div class="shf-reason-add-row row g-2 align-items-end">
                                <div class="col-12 col-md-6 col-lg-2">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Key</label>
                                    <input type="text" id="newHoldReasonKey" class="shf-input w-100"
                                        placeholder="key (e.g. rate_too_high)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">English</label>
                                    <input type="text" id="newHoldReasonEn" class="shf-input w-100"
                                        placeholder="Label (English)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Gujarati</label>
                                    <input type="text" id="newHoldReasonGu" class="shf-input w-100"
                                        placeholder="લેબલ (Gujarati)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-2">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Group</label>
                                    <input type="text" id="newHoldReasonGroup" class="shf-input w-100"
                                        placeholder="Group (e.g. Documents)" list="holdGroupOptions">
                                    <datalist id="holdGroupOptions"></datalist>
                                </div>
                                <div class="col-12 col-lg-2">
                                    <button type="button" id="addHoldReasonBtn"
                                        class="btn-accent-sm w-100 justify-content-center">
                                        <svg class="shf-icon-sm" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        ...
                        <form method="POST" action="{{ route('settings.quotation-cancel-reasons') }}"
                            id="quotationCancelReasonsForm">
                            @csrf
                            <div class="d-flex flex-column gap-2 mb-3" id="quotationCancelReasonsList"></div>
                            <div class="shf-reason-add-row row g-2 align-items-end">
                                <div class="col-12 col-md-6 col-lg-2">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Key</label>
                                    <input type="text" id="newCancelReasonKey" class="shf-input w-100"
                                        placeholder="key (e.g. rate_better_elsewhere)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">English</label>
                                    <input type="text" id="newCancelReasonEn" class="shf-input w-100"
                                        placeholder="Label (English)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Gujarati</label>
                                    <input type="text" id="newCancelReasonGu" class="shf-input w-100"
                                        placeholder="લેબલ (Gujarati)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-2">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Group</label>
                                    <input type="text" id="newCancelReasonGroup" class="shf-input w-100"
                                        placeholder="Group (e.g. Customer)" list="cancelGroupOptions">
                                    <datalist id="cancelGroupOptions"></datalist>
                                </div>
                                <div class="col-12 col-lg-2">
                                    <button type="button" id="addCancelReasonBtn"
                                        class="btn-accent-sm w-100 justify-content-center">
                                        <svg class="shf-icon-sm" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                {{-- Quotation Referral Types --}}
                <div class="settings-tab-pane p-4 shf-collapse-hidden" id="tab-quotation-referral">
                    <p class="small mb-3 shf-text-gray">Configure the referral types users can choose on a quotation
                        (the "Referral Type" dropdown alongside "Referred By").</p>

                    <div>
                        <h6 class="font-display fw-semibold mb-3">Referral Types / સંદર્ભ પ્રકાર</h6>
                        <form method="POST" action="{{ route('settings.quotation-referral-types') }}"
                            id="quotationReferralTypesForm">
                            @csrf
                            <div class="d-flex flex-column gap-2 mb-3" id="quotationReferralTypesList"></div>
                            <div class="shf-reason-add-row row g-2 align-items-end">
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Key</label>
                                    <input type="text" id="newReferralTypeKey" class="shf-input w-100"
                                        placeholder="key (e.g. agent)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <label class="shf-form-label d-block d-lg-none mb-1">English</label>
                                    <input type="text" id="newReferralTypeEn" class="shf-input w-100"
                                        placeholder="Label (English)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <label class="shf-form-label d-block d-lg-none mb-1">Gujarati</label>
                                    <input type="text" id="newReferralTypeGu" class="shf-input w-100"
                                        placeholder="લેબલ (Gujarati)">
                                </div>
                                <div class="col-12 col-md-6 col-lg-2">
                                    <button type="button" id="addReferralTypeBtn"
                                        class="btn-accent-sm w-100 justify-content-center">
                                        <svg class="shf-icon-sm" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if (auth()->user()->hasPermission('manage_permissions'))
                    <div class="settings-tab-pane p-4 shf-collapse-hidden"
                        id="tab-permissions"{!! $activeTab !== 'permissions' ? '' : '' !!}>
