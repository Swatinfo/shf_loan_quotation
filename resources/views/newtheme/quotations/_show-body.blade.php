        ...
        <div class="px-3 px-sm-4 px-lg-5">
                ...
                <div class="shf-section mb-4" style="border-left: 4px solid #d97706;">
                    <div class="shf-section-body">
                        <div class="d-flex align-items-start gap-3">
                            <svg class="shf-icon-lg" fill="none" stroke="#d97706" viewBox="0 0 24 24"
                                style="flex-shrink:0;">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <div>
                                <div class="fw-semibold" style="color:#d97706;">On Hold —
                                    {{ $quotation->hold_reason_label }}</div>
                                ...
                                @if ($quotation->hold_note)
                                    <div class="small mt-2" style="white-space: pre-line;">{{ $quotation->hold_note }}
                                    </div>
                                @endif
                            </div>
                        </div>
            ...
            @elseif($quotation->is_cancelled)
                <div class="shf-section mb-4" style="border-left: 4px solid #c0392b;">
                    <div class="shf-section-body">
                        <div class="d-flex align-items-start gap-3">
                            <svg class="shf-icon-lg" fill="none" stroke="#c0392b" viewBox="0 0 24 24"
                                style="flex-shrink:0;">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <div>
                                <div class="fw-semibold" style="color:#c0392b;">Cancelled —
                                    {{ $quotation->cancel_reason_label }}</div>
                                <div class="small shf-text-gray mt-1">
                                    Cancelled by {{ $quotation->cancelledBy?->name ?? '—' }}
                                    on {{ $quotation->cancelled_at?->format('d M Y, h:i A') }}
                                </div>
                                @if ($quotation->cancel_note)
                                    <div class="small mt-2" style="white-space: pre-line;">{{ $quotation->cancel_note }}
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <dl class="mb-0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <dd class="mt-1">
                                        <span
                                            class="shf-badge
                                            {{ $quotation->customer_type === 'proprietor'
                                                ? 'shf-badge-green'
                                                : ($quotation->customer_type === 'partnership_llp'
                                                    ? 'shf-badge-blue'
                                                    : ($quotation->customer_type === 'pvt_ltd'
                                                        ? 'shf-badge-orange'
                                                        : ($quotation->customer_type === 'salaried'
                                                            ? 'shf-badge-purple'
                                                            : 'shf-badge-gray'))) }}">
                                ...
                                @if ($quotation->referral_name || $quotation->referral_type)
                                    <div class="mb-3">
                                        <dt class="shf-form-label">Referred By</dt>
                                        <dd class="mt-1 small fw-medium">
                                            {{ $quotation->referral_name ?: '—' }}
                                            @if ($quotation->referral_type_label)
                                                <span
                                                    class="shf-badge shf-badge-gray shf-text-2xs">{{ $quotation->referral_type_label }}</span>
                                            @endif
                                        </dd>
                                    </div>
                                @endif
                                <div class="mb-3">
                                    ...
                                    <dd class="mt-1 font-display fw-bold" style="font-size: 1.125rem; color: #f15a29;">
                                        {{ $quotation->formatted_amount }}</dd>
                                </div>
                                @if ($quotation->location)
                                    <div class="mb-3">
                                        <dt class="shf-form-label">Location</dt>
                                        <dd class="mt-1 small">
                                            {{ $quotation->location->parent?->name ? $quotation->location->parent->name . ' / ' : '' }}{{ $quotation->location->name }}
                                        </dd>
                                    </div>
                                @endif
                            </dl>
                        ...
                        <div class="col-md-6">
                            <dl class="mb-0">
                                <div class="mb-3">
                                    ...
                                    <dd class="mt-1 small">
                                        {{ $quotation->created_at ? $quotation->created_at->format('d M Y, h:i A') : 'N/A' }}
                                    </dd>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <dd class="mt-1 small">
                                            ...
                                            @if ($quotation->prepared_by_mobile)
                                                <span
                                                    style="color: #6b7280; margin-left: 4px;">({{ $quotation->prepared_by_mobile }})</span>
                                            @endif
                                        </dd>
                                    </div>
                                @endif
                                @if ($quotation->pdf_filename)
                                    <div class="mb-3">
                                        ...
                                        <dd class="mt-1 small text-truncate shf-text-gray"
                                            title="{{ $quotation->pdf_filename }}">{{ $quotation->pdf_filename }}</dd>
                                    </div>
                                @endif
                            </dl>
                        </div>
                    ...
                    <div class="shf-section-body">
                        <div class="shf-doc-grid">
                            @foreach ($quotation->documents as $doc)
                                <div class="shf-doc-item shf-doc-row {{ $doc->is_excluded ? 'shf-doc-struck' : 'checked' }}"
                                    data-doc-id="{{ $doc->id }}">
                                    @if ($doc->is_excluded)
                                        <svg style="width:16px;height:16px;color:#9ca3af;flex-shrink:0;" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                    @else
                                        <svg style="width:16px;height:16px;color:#f15a29;flex-shrink:0;" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div class="small flex-grow-1">
                                        <span class="fw-medium shf-doc-text">{{ $doc->document_name_en }}</span>
                                        @if ($doc->document_name_gu)
                                            <span class="shf-doc-text" style="color: #6b7280; margin-left: 4px;">/
                                                {{ $doc->document_name_gu }}</span>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
            ...
            <style>
                .shf-doc-grid .shf-doc-row.shf-doc-struck .shf-doc-text {
                    text-decoration: line-through;
                    color: #9ca3af;
                }

                .shf-doc-grid .shf-doc-row.shf-doc-struck {
                    opacity: 0.65;
                }
            </style>
                    ...
                    <div class="shf-section mb-4">
                        <div class="shf-section-header">
                            <div class="shf-section-number">
                                {{ ($quotation->documents->count() > 0 ? 3 : 2) + $bankIdx }}</div>
                        ...
                        <div class="shf-section-body">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    @php
                                        $chargeItems = [
                                            ...
                                            [
                                                'label' => 'Stamp Paper and Notary Charges',
                                                'value' => $bank->stamp_notary,
                                            ],
                                        ...
                                        if ($bank->extra1_name) {
                                            $chargeItems[] = [
                                                'label' => $bank->extra1_name,
                                                'value' => $bank->extra1_amount,
                                            ];
                                        }
                                        if ($bank->extra2_name) {
                                            $chargeItems[] = [
                                                'label' => $bank->extra2_name,
                                                'value' => $bank->extra2_amount,
                                            ];
                                        }
                                    @endphp
                                    @foreach ($chargeItems as $item)
                                        @if ($item['value'] > 0)
                                            <div class="col-sm-6 col-md-3">
                                                <div
                                                    style="background: var(--bg); border: 1px solid var(--border); border-radius: 8px; padding: 10px 14px;">
                                                    <div class="small shf-text-gray">{{ $item['label'] }}</div>
                                                    <div class="small fw-semibold font-display mt-1">₹
                                                        {{ number_format($item['value']) }}</div>
                                                </div>
                                            </div>
                                        @endif
                                    @endforeach
                                ...
                                <div class="mt-3 d-flex justify-content-end">
                                    <div
                                        style="background: var(--accent-dim); border: 1px solid var(--accent); border-radius: 8px; padding: 8px 16px;">
                                        <span class="small fw-semibold shf-text-accent">Total Charges:</span>
                                        <span class="small fw-bold font-display ms-2 shf-text-accent">₹
                                            {{ number_format($bank->total_charges) }}</span>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                @foreach ($bank->emiEntries->sortBy('tenure_years') as $emi)
                                                    <tr>
                                                        ...
                                                        <td class="text-end fw-semibold font-display">₹
                                                            {{ number_format($emi->monthly_emi) }}</td>
                                                        <td class="text-end shf-text-gray">₹
                                                            {{ number_format($emi->total_interest) }}</td>
                                                        <td class="text-end fw-semibold font-display">₹
                                                            {{ number_format($emi->total_payment) }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
            ...
            @if ($quotation->additional_notes)
                <div class="shf-section mt-4">
                    ...
                    <div class="shf-section-body">
                        <p class="small mb-0" style="color: #374151; white-space: pre-line;">
                            {{ $quotation->additional_notes }}</p>
                    </div>
                </div>
            @endif
    ...
    {{-- Hold Modal --}}
    @if (
        $quotation->status === \App\Models\Quotation::STATUS_ACTIVE &&
            !$quotation->is_converted &&
            auth()->user()->hasPermission('hold_quotation'))
                ...
                <div class="modal-content" style="border-radius: var(--radius); border: 1px solid var(--border);">
                    <form method="POST" action="{{ route('quotations.hold', $quotation) }}" id="holdForm">
                        ...
                        <div class="modal-body p-4">
                            <p class="small mb-3 shf-text-gray">A follow-up DVR will be automatically created with the
                                date you provide below.</p>
                            <div class="mb-3">
                                ...
                                <select name="reason_key" class="shf-input" required>
                                    ...
                                    @php
                                        $groupedHold = collect($holdReasons)
                                            ->groupBy(fn($r) => $r['group'] ?? 'Other')
                                            ->sortKeys();
                                    @endphp
                                    @foreach ($groupedHold as $groupName => $groupReasons)
                                        <optgroup label="{{ $groupName }}">
                                            @foreach ($groupReasons as $reason)
                                                <option value="{{ $reason['key'] }}">{{ $reason['label_en'] }} /
                                                    {{ $reason['label_gu'] }}</option>
                                            @endforeach
                                        </optgroup>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                <label class="shf-form-label">Follow-up Date <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="follow_up_date" class="shf-input shf-datepicker"
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="border-radius: var(--radius); border: 1px solid var(--border);">
                    <form method="POST" action="{{ route('quotations.cancel', $quotation) }}" id="cancelForm">
                        ...
                        <div class="modal-body p-4">
                            <p class="small mb-3 shf-text-gray" style="color:#c0392b!important;">Cancelled quotations
                                cannot be resumed or converted to a loan. This is a terminal state.</p>
                            <div class="mb-3">
                                <label class="shf-form-label">Reason <span class="text-danger">*</span></label>
                                <select name="reason_key" class="shf-input" required>
                                    <option value="">Select a reason…</option>
                                    @php
                                        $groupedCancel = collect($cancelReasons)
                                            ->groupBy(fn($r) => $r['group'] ?? 'Other')
                                            ->sortKeys();
                                    @endphp
