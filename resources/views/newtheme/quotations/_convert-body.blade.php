                ...
                <div class="shf-section-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="pan_number" id="convertPan" class="shf-input w-100" required
                                   value="{{ old('pan_number') }}" placeholder="ABCDE1234F" maxlength="10"
                                   style="text-transform: uppercase;" autocomplete="off">
                            <small class="text-muted shf-pan-lookup-hint" style="display:none;"></small>
                            <div class="shf-pan-loans mt-1 shf-text-sm" style="display:none;"></div>
                            @error('pan_number')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
