...
@push('page-styles')
    ...
    {{-- Strike-out doc rows — line-through label so the user sees what they
         excluded instead of the row silently disappearing. Shared with the
         edit page (which @push'es the same key). --}}
    <style>
        .shf-doc-row {
            ...
            <div class="px-3 px-sm-4 px-lg-5">
                ...
                <div id="pendingSyncBadge" class="shf-collapse-hidden text-center mb-2">
                    <button type="button" onclick="syncNow()" id="syncNowBtn"
                        ...
                        <span id="syncNowLabel" style="margin-left:4px;font-size:0.75rem;opacity:0.9;">— Tap to sync /
                            સિંક કરવા ટેપ કરો</span>
                    </button>
                </div>
                ...
                <div class="qc-submit-row d-flex justify-content-center gap-3 py-4">
                    <a href="{{ route('quotations.index') }}" class="btn-accent-outline"
