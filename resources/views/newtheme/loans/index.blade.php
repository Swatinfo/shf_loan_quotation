...
@section('content')
    ...
    <main class="content">
        ...
        <div class="card mt-4 lx-filters-card collapsed" id="lxFiltersCard">
            <div class="card-hd lx-filters-toggle" id="lxFiltersToggle" role="button" tabindex="0" aria-expanded="false"
                aria-controls="lxFiltersBody">
                <div class="t">
                    <span class="lx-filter-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path
                                d="M3 4a1 1 0 011-1h16a1 1 0 01.78 1.625l-6.28 7.85V20a1 1 0 01-1.45.894l-4-2A1 1 0 019 18v-5.525L2.22 4.625A1 1 0 013 4z" />
                        </svg>
                    </span>
                    Filters
            ...
            <div class="card-bd lx-filters-body" id="lxFiltersBody">
                <div class="lx-filters">
                    ...
                    <div class="lx-field">
                        ...
                        <select id="lxProduct" class="select">
                            <option value="">All Products</option>
                            @foreach ($products as $product)
                                <option value="{{ $product->id }}" data-bank-id="{{ $product->bank_id }}">
                                    {{ $product->name }} — {{ $product->bank?->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    @if ($permissions['is_admin_or_manager'])
                        ...
                        <div class="lx-field">
                            <label class="lbl">Task Owner</label>
                            <select id="lxUser" class="select">
                    ...
                    @if (!$permissions['is_bank_employee'])
                        <div class="lx-field">
                            ...
                            <select id="lxDocket" class="select">
                                ...
                                <option value="s_plus_1">S+1 (1 day after sanction)</option>
                                <option value="s_plus_2">S+2 (2 days after sanction)</option>
                                <option value="s_plus_3">S+3 (3 days after sanction)</option>
                                <option value="custom">Custom Date…</option>
                            </select>
                        </div>
                        <div class="lx-field lx-hidden" id="lxDocketDateWrap">
                            <label class="lbl">Docket By</label>
                            <input type="text" id="lxDocketDate" class="input shf-datepicker" autocomplete="off"
                                placeholder="dd/mm/yyyy">
                        </div>
                    @endif
                    <div class="lx-field">
                        <label class="lbl">From</label>
                        <input type="text" id="lxDateFrom" class="input shf-datepicker" autocomplete="off"
                            placeholder="dd/mm/yyyy">
                    </div>
                    <div class="lx-field">
                        <label class="lbl">To</label>
                        <input type="text" id="lxDateTo" class="input shf-datepicker" autocomplete="off"
                            placeholder="dd/mm/yyyy">
                    </div>
                    <div class="lx-field">
        ...
        <div class="card mt-4 lx-results">
            <div class="card-hd d-flex justify-content-between align-items-center gap-2 flex-wrap">
                <div class="t"><span class="num">L</span>Loans <span class="sub" id="lxResultCount">—</span>
                </div>
                <input type="search" id="lxSearch" class="input" autocomplete="off"
                    placeholder="Search loan # / customer / phone / bank…" style="max-width:320px;min-width:200px;">
            </div>
...
@push('page-scripts')
    <script>
        window.__LX = {
            ...
            canSeeUser: @json($permissions['is_admin_or_manager']),
        };
    </script>
